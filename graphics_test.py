...
import progress
import os,sys, json, subprocess, re,bullet
...
def banner():
    ...
    print(Fore.CYAN +""" 
  ____                          _____                     _           
 |  _ \ ___   __ _ _   _  ___  | ____|_ __   ___ ___   __| | ___ _ __ 
 | |_) / _ \ / _` | | | |/ _ \ |  _| | '_ \ / __/ _ \ / _` |/ _ \ '__|
 |  _ < (_) | (_| | |_| |  __/ | |___| | | | (_| (_) | (_| |  __/ |   
 |_| \_\___/ \__, |\__,_|\___| |_____|_| |_|\___\___/ \__,_|\___|_|   
             |___/                                                      """)

    print(Fore.BLUE+"---------------------------------------------------------------------")
    print(Fore.LIGHTCYAN_EX+"                 Terminal User Video Encoder ")
    print(Fore.RED+"           Created By: @Zero_Prime9 and @GComputeNerd ") 
    print(Fore.YELLOW+"                        Version:0.1.0 ") 
    print(Fore.BLUE+"---------------------------------------------------------------------")
...
def Arguments():
  ...
  show_usage = (
                ...
                f'\nExample Usage : '
                f'\npython3 {sys.argv[0]} Fun_Video.mp4\n'
  )
...
def main_prompt(stay): #Main Menu
